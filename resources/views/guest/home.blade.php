...
@section('content')
    ...
    <section class="bg-blue-50 rounded-2xl px-6 py-16 text-center mb-8">
        ...
        <div class="flex justify-center gap-3">
            <a href="#" class="px-5 py-2.5 bg-blue-500 text-white rounded-lg text-sm font-medium hover:bg-blue-600 transition">
                Gabung Sekarang
            </a>
            <a href="#" class="px-5 py-2.5 border border-gray-300 rounded-lg text-sm font-medium text-gray-700 hover:bg-gray-100 transition">
    ...
    <section class="bg-blue-50 rounded-2xl px-6 py-12 text-center">
        ...
        <div class="flex justify-center gap-3">
            <a href="#" class="px-5 py-2.5 bg-blue-500 text-white rounded-lg text-sm font-medium hover:bg-blue-50 hover:text-blue-500 hover:border transition">
                Sign Up
            </a>
            <a href="#" class="px-5 py-2.5 border border-gray-500 text-gray-900 rounded-lg text-sm font-medium hover:bg-gray-800 hover:text-white transition">
                Sign In
            </a>
        </div>
    </section>
